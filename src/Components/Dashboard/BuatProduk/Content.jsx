            ...
            onSubmit={(event) => {
              ...
              async function sendDataProduct(dataProduct) {
                try {
                  ...
                  formData.append(
                    "price_product",
                    data["price_product"].replace(/\./g, "")
                  );
                  formData.append("stock_product", data["stock_product"]);
                  formData.append(
                    "min_order_product",
                    data["min_order_product"]
                  );
              ...
              <div className={css.input}>
                <input
                  ...
                  onKeyUp={(e) => {
                    ...
                    const filterCategory = dataCategory.filter((category) =>
              ...
              <>
                <div className={css.form_information_product}>
                  ...
                  <div className={css.input_desc_product}>
                    <div className={css.desc_product_text}>
                      Deskripsi Produk
                    </div>

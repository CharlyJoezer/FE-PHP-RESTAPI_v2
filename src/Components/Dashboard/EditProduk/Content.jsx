              ...
              onSubmit={(event) => {
                ...
                (async ()=>{
                  try{
                    ...
                    const response = await request.json()
                    if(request.status === 200){
                      setPopup({show:true, status:'Success', message:'Product berhasil diupdate!'})
                      setTimeout(() => {
                ...
                <>
                  <div className={css.form_information_product}>
                    ...
                    <div className={css.input_image_product}>
                      ...
                      <div className={css.wrapper_input_file} style={{
                        backgroundImage : `url(${BASEURL()}/api/image/product/${dataProduct.gambar_produk})`
                      }}>
                        <input
                          type="file"
                          name="gambar_produk"

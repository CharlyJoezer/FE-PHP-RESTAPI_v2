                ...
                <div className={css.shop_profil}>
                    <div className={css.shop_profil_content}>
                        <div className={css.shop_about}>
                            <img src="https://imgop.itemku.com/?url=https%3A%2F%2Fitemku-upload.s3.ap-southeast-1.amazonaws.com%2Fitemku-upload%2F20211013%2Fp0el1iqv1se7abjmy6l4np.png&w=32&q=75" alt="https://imgop.itemku.com/?url=https%3A%2F%2Fitemku-upload.s3.ap-southeast-1.amazonaws.com%2Fitemku-upload%2F20211013%2Fp0el1iqv1se7abjmy6l4np.png&w=32&q=75" />
                            <div className={css.shop_about_data}>
                                <div className={css.shop_about_name}>Lopix Store</div>
                                <span className={css.shop_about_status}>Status : Tutup</span>
                            </div>
                        </div>
                    ...
                    <div className={css.list_activity}>
                        <div className={css.box_activity}>
                            ...
                            <div className={css.box_activity_info}>
                                ...
                                <span className={css.box_activity_info_count}>0</span>
                            </div>
                        </div>
                        <div className={css.box_activity}>

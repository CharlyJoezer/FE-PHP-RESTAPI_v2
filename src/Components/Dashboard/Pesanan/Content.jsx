        ...
        <>
            <div className={css.container_content}>
                ...
                <div className={css.list_orders}>
                    <div className={css.box_order}>
                        <div className={`${css.order_status} ${css.order_status_menunggu_konfirmasi}`}>
                        ...
                        <div className={css.wrapper_order_data}>
                            <div className={css.order_data_and_buyer_1}>
                                <div className={css.order_time_and_id}>
                                    <div className={css.order_time}>12 Juli 2023 18:22:36</div>
                                    <div className={css.order_id}>OD000000109682050 (ID)</div>
                                </div>
                                <div className={css.order_buyer_and_chat}>
                                    <div className={css.order_buyer}>Charly</div>
                            ...
                            <div className={css.order_data_and_buyer_2}>
                                <div className={css.order_product_name}>AKUN BARU + CUSTOM NAME</div>
                                <div className={css.order_product_category}>Growtopia</div>
                                <div className={css.order_amount}>1 Akun</div>
                                <div className={css.order_price}>Rp 5.000</div>
                            </div>
                    ...
                    <div className={css.box_order}>
                        <div className={`${css.order_status} ${css.order_status_pesanan_selesai}`}>
                            Pesanan Selesai
                        </div>
                        <div className={css.wrapper_order_data}>
                            <div className={css.order_data_and_buyer_1}>
                    ...
                    <div className={css.box_order}>
                        <div className={`${css.order_status} ${css.order_status_perlu_diproses}`}>
                            Perlu diproses
                        </div>
                        <div className={css.wrapper_order_data}>
                            <div className={css.order_data_and_buyer_1}>
                    ...
                    <div className={css.box_order}>
                        <div className={`${css.order_status} ${css.order_status_pesanan_dibatalkan}`}>
                            Pesanan Dibatalkan
                        </div>
                        <div className={css.wrapper_order_data}>
                            <div className={css.order_data_and_buyer_1}>

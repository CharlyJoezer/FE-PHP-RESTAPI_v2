...
const Sub_Categories = () => {
  ...
  document.title =
    params.name_sub_category.charAt(0).toUpperCase() +
    params.name_sub_category.slice(1) +
    " | Itemku";
  return (
    <>
      <div className={css.container_sub_categories}>
        ...
        <Content
          ...
          name_sub_category={params.name_sub_category}
          name_type_category={params.typeCategory}
        />
      </div>
      <Navbar />
    </>
